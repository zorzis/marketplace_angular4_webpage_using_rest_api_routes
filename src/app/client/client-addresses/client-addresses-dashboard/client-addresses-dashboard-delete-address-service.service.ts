...
@Injectable()
export class ClientDashboardDeleteAddressesService {

  private deleteClientAddressURL = 'http://localhost:9090/client/delete_address';
  ...
  public deleteClientAddress(clientEmail: string,
                             clientAddressIDForDeletion: string) {

    console.log(`Hello from ClientDashboardDeleteAddressesService::deleteClientAddress`);

    // set the request parameters to be send
    const urlSearchParams = new URLSearchParams();
    urlSearchParams.append('email', clientEmail);
    urlSearchParams.append("addressID", clientAddressIDForDeletion);
    ...
    return this.http.post(this.deleteClientAddressURL, paramsBody, options)
