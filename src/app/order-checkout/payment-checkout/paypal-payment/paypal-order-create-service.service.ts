...
@Injectable()
export class PaypalOrderCreateService {
  // URL to REST API
  private newPaypalOrderCreationURL: string = 'http://localhost:9090/client/order-checkout/paypal';
  ...
  public onCreateNewOrderForPaypalPayment(data: ShoppingCartDTO ): Observable<ShoppingCartDTO> {
    console.log('Hello from PaypalOrderCreateService::onCreateNewOrderForPaypalPayment');
    ...
    return this.http.post(this.newPaypalOrderCreationURL, data, options)
  ...
  public parameterIsNull(someValue: any) {
    console.log('Hello from PaypalOrderCreateService::parameterIsNull');
