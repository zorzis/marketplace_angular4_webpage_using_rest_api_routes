...
@Injectable()
export class ClientOrdersDashboardService {

  // URL to REST API
  private getAllClientOrdersURL: string = 'http://localhost:9090/client/get_orders';
  ...
  public getClientOrders(clientEmail: string): Observable<Array<Order>> {
    console.log('Hello from ClientOrdersService::getClientOrders');
    ...
    return this.http.post(this.getAllClientOrdersURL, paramsBody, options)
  ...
  public parameterIsNull(someValue: any) {
    console.log('Hello from  ClientOrdersDashboardService::parameterIsNull');
