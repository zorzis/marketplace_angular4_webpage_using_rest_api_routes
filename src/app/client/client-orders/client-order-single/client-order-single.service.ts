...
@Injectable()
export class ClientOrderSingleService {

  // URL to REST API
  private getClientOrderSingleURL: string = 'http://localhost:9090/client/get_single_order';
  ...
  public getClientOrderSingle(clientEmail: string, orderID: string): Observable<Order> {
    console.log(`Hello from ClientOrderSingleService::getClientOrderSingle`);
    ...
    return this.http.post(this.getClientOrderSingleURL, paramsBody, options)
